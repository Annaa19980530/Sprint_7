...
public class TestCreateOrder{
    ...
    public static Object[][] getTestData(){
        return new Object[][]{
                {new Order("Иван","Иванов","Советская","Ленинское","+79099995566",2,"2024-07-12","Позвонить за час",new String[]{"BLACK"})},
                {new Order("Петр","Петров","Дьяконова","Московское","89199895767",3,"2024-06-30","Позвонить за час",new String[]{"GREY"})},
