...
public class TestCreateCourier{
        ...
        Courier courier = new Courier("SuperCourier", "777", "Anna");
    ...
    public void checkCreateCourierWithoutLogin(){
        courierRequest.setCourier(new Courier("","777","Anna"));
        courierRequest.createCourier()
    ...
    public void checkCreateCourierWithoutPassword(){
        courierRequest.setCourier(new Courier("SuperCourier","","Anna"));
        courierRequest.createCourier()
                .then().statusCode(SC_BAD_REQUEST)
                .and()
                .assertThat().body("message",equalTo("Недостаточно данных для создания учетной записи"));
